...
struct MatmulPolicyDefault {
    ...
    using CopyCubeInA       =   matmul::CopyCubeIn<IMPL, MatmulInputTypeA<A_TYPE>, MM_CFG>;
    using CopyCubeInB       =   matmul::CopyCubeIn<IMPL, MatmulInputTypeB<B_TYPE>, MM_CFG>;

    using CopyInBufferA     =   matmul::CopyInBuffer<IMPL, MatmulInputTypeA<A_TYPE>, MM_CFG>;
    using CopyInBufferB     =   matmul::CopyInBuffer<IMPL, MatmulInputTypeB<B_TYPE>, MM_CFG>;
